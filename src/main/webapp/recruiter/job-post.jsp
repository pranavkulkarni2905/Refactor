...
<%@ include file="_sidebar.jsp" %>
  ...
  <%try{
    ...
    <section class="section dashboard">
     <div class="card">
    <div class="card-body">
      <h5 class="card-title"><i class="bi bi-file-post"></i> Post a job</h5>

      <!-- Multi Columns Form -->
      <form action="../JobPostController" method="post" class="row g-3">
        
        <input type="hidden" name="id" value="<%=u.getRecruiterId() %>">
         <input type="hidden" name="name" value="<%=u.getCompanyName() %>">
        <div class="col-md-4">
