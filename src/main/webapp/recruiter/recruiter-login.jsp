...
<head>
  ...
  <title>WorkConnect | Recruiter Login</title>
...
<%try{
			boolean msg = (boolean) session.getAttribute("recrutier-register-success");
			if (msg==true) {
			%>
        ...
        <div class="toast fade show">
            ...
            <div class="toast-body">
               <h5><b> Registration Successfully!
            </b></h5>
            </div>
        </div>
        </div>
			...
			session.removeAttribute("recrutier-register-success");
			%>
			<%try{
			Boolean msg1 = (Boolean) session.getAttribute("recrutier-register-fail");
			if (msg1==false) {
			%>
				<div class="toast-container" style="position: absolute; top: 10px; right: 10px;">
        ...
        <div class="toast fade show">
			...
			session.removeAttribute("recrutier-register-fail");
			%>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="../RecruiterLoginController" method="post" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="recruiter-register.jsp">Create an account</a></p>
                    </div>
                  </form>
