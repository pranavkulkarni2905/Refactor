    ...
    <div class="row mb-3">   
     ...
     <div class="card" ><!-- style="height :50rem" -->
            <div class="card-body">
              ...
              <form id ="signUpForm" class="row g-3 pt-1">
        ...
        <div class="form-header d-flex mb-4">
            <span class="stepIndicator">Personal Information</span>
            <span class="stepIndicator">Social Profile</span>
            <span class="stepIndicator">Resume</span>
            <span class="stepIndicator">Apply</span>
        </div> -->
     ...
     <!-- Default Card -->
          <div class="card" style="height: 590px; overflow-y: auto;">
            <div class="card-body" style="font-size:16px;">
              ...
              <p class="card-text">Graduate Engineering Trainee (Fresher) in HiPaaS is responsible for the programming and development of applications and software using Python/React/C#/Boomi/etc. Individuals in this role should possess a strong logical and technical bent of mind.</p>
              
              
              <p class="card-text"><b>Job Requirements/qualification</b> </p>
              
              <p class="card-text"><!-- List group with active and disabled items -->
              <ul class="list-group list-group-flush">
                <li class="list-group-item">Degree BE/BTech in Computer Science/IT or MCA degree.</li>
                <li class="list-group-item">eager to learn, adapt and excel in an extreme technology</li>
                <li class="list-group-item">Deep understanding of algorithm and data structure is a MUST</li>
                <li class="list-group-item">Sound understanding of coding and development processes.</li>
               
              </ul><!-- End Clean list group --></p>
              <p class="card-text"><b>Job Nature: </b> <span>Full Time</span></p>
              
              <p class="card-text"><b>Location: </b><span>Pune</span></p>
              <p class="card-text"><b>Deadline: </b></p>
