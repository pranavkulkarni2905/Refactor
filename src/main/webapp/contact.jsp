            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link text-white-50" href="job-list.html">Job Listings</a>
                        <a class="btn btn-link text-white-50" href="privacy_policy.html">Privacy Policy</a>
                        <a class="btn btn-link text-white-50" href="termsconditions.html">Terms & Condition</a>
                    </div>
                    <div class="col-lg-3 col-md-6">
